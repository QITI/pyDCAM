...
class DCAMPROPATTRIBUTE(IntEnum):
	...
	DCAMPROP_ATTR_HASRATIO =_int32( _int32(0x)0100000)	# value has ratio control capability		*/
...
class DCAMIDPROP(IntEnum):
	...
	DCAM_IDPROP_NUMBEROF_OUTPUTTRIGGERCONNECTOR	= _int32(0x001C0010)	# R/O, long,	"NUMBER OF OUTPUT TRIGGER CONNECTOR"*/
	...
	DCAM_IDPROP_NUMBEROF_REALTIMEGAINCORRECTREGION=_int32(0x003001A0)	# R/W,	long,	"NUMBER OF REALTIME GAIN CORRECT REGION"*/
	...
	DCAM_IDPROP_REALTIMEGAINCORRECTREGION_HPOS	= _int32(0x00301000)	# R/W,	long,	"REALTIME GAIN CORRECT REGION HPOS"		*/
	DCAM_IDPROP_REALTIMEGAINCORRECTREGION_HSIZE	= _int32(0x00302000)	# R/W,	long,	"REALTIME GAIN CORRECT REGION HSIZE"	*/

	DCAM_IDPROP__REALTIMEGAINCORRECTIONREGION	= _int32(0x00000010)	# the offset of ID for Nth REALTIME GAIN CORRECT REGION parameter	*/
	...
	DCAM_IDPROP_SHADINGCALIB_STABLEMININTENSITY	= _int32(0x00380360)	# R/W, long,	"SHADING CALIB STABLE MIN INTENSITY"	*/
	...
	DCAM_IDPROP_SHADINGCALIB_STABLEMAXERRORPERCENT=_int32(0x00380390)	# R/W, long,	"SHADING CALIB STABLE MAX ERROR PERCENT" */
	...
	DCAM_IDPROP_IMAGEDETECTOR_PIXELWIDTH		= _int32(0x00420810)	# R/O, micro-meter, "IMAGE DETECTOR PIXEL WIDTH"	*/	/* reserved */
	DCAM_IDPROP_IMAGEDETECTOR_PIXELHEIGHT		= _int32(0x00420820)	# R/O, micro-meter, "IMAGE DETECTOR PIXEL HEIGHT"	*/	/* reserved */
